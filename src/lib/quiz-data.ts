...
export const CONTEXT_QUESTIONS: ContextQuestion[] = [
  {
    id: "X1",
    text: "Qual è il settore principale della vostra azienda?",
    options: [
  ...
  {
    id: "X3",
    text: "Qual è il suo ruolo in azienda?",
    options: [
      "Titolare / CEO",
...
export const AXES: Axis[] = [
    ...
    questions: [
      {
        ...
        options: [
          ...
          { letter: "B", score: 2, text: "Il CEO/direzione ne hanno sentito parlare, ma non è una priorità e non abbiamo fatto nulla di concreto." },
      ...
      },
      {
        ...
        options: [
          ...
          { letter: "C", score: 3, text: "Abbiamo iniziato a fare un elenco, ma è incompleto o non aggiornato." },
          { letter: "D", score: 4, text: "Elenco completo e aggiornato: per ogni strumento documentiamo chi lo usa, per quale attività, con quale livello di rischio (basso/medio/alto). Abbiamo verificato che nessun uso rientri in pratiche vietate." },
      ...
      },
      {
        ...
        options: [
          ...
          { letter: "C", score: 3, text: "Stiamo scrivendo documenti specifici; alcuni già aggiornati per i trattamenti principali." },
          ...
          { letter: "E", score: 5, text: "Informative complete, revisionate periodicamente, con linguaggio comprensibile e verifiche di conformità." },
        ],
      },
      {
        id: "C4",
        ...
        options: [
          ...
          { letter: "B", score: 2, text: "Qualcuno si è informato per conto suo (corsi online, articoli), ma niente di organizzato dall'azienda." },
          { letter: "C", score: 3, text: "Formazione avviata o in preparazione; copertura parziale (meno del 50% del personale coinvolto)." },
          { letter: "D", score: 4, text: "Formazione strutturata erogata; oltre il 50% del personale già formato; piano per completare il resto." },
      ...
      },
      {
        ...
        options: [
          ...
          { letter: "B", score: 2, text: "Ci pensiamo, ma non c'è un processo formale nè una documentazione scritta." },
    ...
    questions: [
      {
        ...
        options: [
          ...
          { letter: "D", score: 4, text: "La policy è firmata da tutti i dipendenti interessati. Abbiamo verificato l'aderenza almeno una volta (audit, survey, o colloqui). L'abbiamo aggiornata almeno una volta." },
      ...
      },
      {
        ...
        options: [
          { letter: "A", score: 1, text: "Non c'è un processo. Se serve a qualcuno, lo usiamo." },
          { letter: "B", score: 2, text: "A volte lo si chiede al responsabile; a volte si fa direttamente. Niente di strutturato." },
          { letter: "C", score: 2.5, text: "Abbiamo una checklist informale (dati sensibili? privacy? licenze?) ma non è ancora una procedura scritta." },
          { letter: "D", score: 4, text: "Procedura scritta: chi vuole usare un nuovo strumento AI compila una richiesta. Un responsabile lo approva verificando dati, sicurezza, conformità. Lo classifichiamo come \"via libera\", \"con condizioni\" o \"vietato\"." },
          { letter: "E", score: 5, text: "La procedura è integrata nel processo di acquisti e change management. Tutti i nuovi strumenti (AI e non) seguono lo stesso percorso. Verifica ogni 6 mesi." },
        ],
      },
      {
        id: "G3",
        text: "Chi è responsabile della governance e della sicurezza dell'AI nella vostra azienda?",
        options: [
          { letter: "A", score: 1, text: "Nessuno in particolare. Non abbiamo assegnato questa responsabilità." },
          { letter: "B", score: 2, text: "Ne parla il CEO o il direttore, ma non è un ruolo formalizzato. Se ne occupa \"quando serve\"." },
          ...
          { letter: "D", score: 4, text: "Un responsabile AI (o comitato) è operativo: ha approvato gli ultimi nuovi strumenti, supervisiona l'uso, comunica rischi al management." },
          { letter: "E", score: 5, text: "La governance AI è affidata a un referente/comitato con meeting regolari, metriche tracciate e coinvolgimento di management, IT, compliance. Revisione annuale dei rischi." },
        ],
      },
      {
        id: "G4",
        ...
        options: [
          ...
          { letter: "B", score: 2, text: "Sappiamo che certi usi sono più rischiosi, ma non abbiamo una classificazione scritta." },
          { letter: "C", score: 3, text: "Abbiamo una classificazione scritta (basso, medio, alto rischio) e la usiamo quando approviamo nuovi strumenti, ma non per tutte le attività già in corso." },
          { letter: "D", score: 4, text: "Usiamo un sistema formale per qualificare ogni attività AI: quali dati tratta, che impatto ha, è conforme? Lo applichiamo sia ai nuovi strumenti sia a quelli esistenti." },
          { letter: "E", score: 5, text: "La classificazione del rischio è integrata nei processi aziendali standard. La aggiorniamo quando emergono nuovi rischi. Tracciamo metriche (quanti usi a rischio alto, medio, basso)." },
        ],
      },
      {
        id: "G5",
        ...
        options: [
          ...
          { letter: "B", score: 2, text: "Il management è consapevole e ogni tanto chiede feedback, ma non c'è un sistema strutturato." },
          { letter: "C", score: 3, text: "Abbiamo un registro base degli strumenti e di chi li usa. Rivediamo la policy almeno una volta l'anno. Non c'è un processo formale per gestire gli incidenti." },
    ...
    questions: [
      {
        ...
        options: [
          ...
          { letter: "D", score: 4, text: "Il 30-60% dei dipendenti usa l'AI regolarmente in più reparti." },
      ...
      },
      {
        ...
        options: [
          { letter: "A", score: 1, text: "Ogni persona fa da sè, nessun coordinamento. Ognuno usa strumenti diversi." },
          { letter: "B", score: 2, text: "Pochi usano lo stesso strumento, ma senza processi definiti. Molti sperimentano in modo casuale." },
          { letter: "C", score: 3, text: "Un team o un reparto usa l'AI in modo coordinato per attività specifiche e definite." },
          { letter: "D", score: 4, text: "2-3 reparti hanno processi AI definiti e documentati, con guide interne." },
          { letter: "E", score: 5, text: "L'AI è integrata nei flussi standard. Tutti i reparti principali hanno processi codificati." },
        ],
      },
      {
        id: "A3",
        text: "Avete agenti AI o automazioni configurate per attività specifiche (es. rispondere a domande frequenti, estrarre dati da documenti, assistere il commerciale)?",
        options: [
          ...
          { letter: "C", score: 3, text: "1-3 agenti configurati per attività specifiche e usati regolarmente dal team." },
          { letter: "D", score: 4, text: "4-6 agenti attivi in almeno 2 reparti diversi, con risultati documentati." },
          { letter: "E", score: 5, text: "7 o più agenti integrati in processi critici su 3 o più reparti." },
        ],
      },
      {
        id: "A4",
        text: "Come documentate i vostri casi d'uso AI? (quali attività fate con l'AI, come, con quali risultati)",
        options: [
          { letter: "A", score: 1, text: "Non documentati. Ogni persona sa cosa fa, ma non c'è una mappa condivisa." },
      ...
      {
        id: "A5",
        text: "Misurate l'impatto dell'AI sulle vostre attività? (tempo risparmiato, errori ridotti, costi, soddisfazione)",
        options: [
  ...
  },
  {
    ...
    questions: [
      {
        id: "S1",
        text: "Nel vostro team, quanta esperienza pratica c'è con strumenti di intelligenza artificiale?",
        options: [
          { letter: "A", score: 1, text: "Nessuna. Qualcuno ha provato ChatGPT per curiosità personale, ma non fa parte del lavoro." },
          ...
          { letter: "E", score: 5, text: "L'AI è integrata nel lavoro quotidiano. Gli esperti interni formano i nuovi colleghi, il team propone autonomamente nuovi casi d'uso." },
        ],
      },
      {
        id: "S2",
        ...
        options: [
          { letter: "A", score: 1, text: "No. Per noi \"AI\" significa soprattutto automazione e produttività. Non pensiamo a rischi normativi." },
          ...
          { letter: "C", score: 3, text: "Il management ha ricevuto formazione base su governance AI: conosce i rischi, gli obblighi, ed è in grado di citare almeno 2 rischi concreti legati all'uso dell'AI in azienda." },
          { letter: "D", score: 4, text: "Management valuta autonomamente nuovi strumenti rispetto a conformità, privacy, impatto. Processo documentato con referente che verifica." },
      ...
      {
        id: "S3",
        text: "Nel vostro team, c'è almeno una persona che sa creare contenuti efficaci con l'AI, configurare uno strumento, e potrebbe insegnarlo a un collega?",
        options: [
          { letter: "A", score: 1, text: "No, nessuno ha queste competenze. Quando serve, chiediamo a fornitori esterni." },
          { letter: "B", score: 2, text: "1-2 persone hanno queste capacità, ma in modo autodidatta. Non sono riconosciute come referenti." },
          ...
          { letter: "E", score: 5, text: "Abbiamo una rete interna di campioni AI che si formano a vicenda. Almeno uno può formare nuovi colleghi. Esiste un canale formale per dubbi tecnici e normativi." },
        ],
      },
      {
        id: "S4",
        text: "Quanto il vostro team è in grado di usare strumenti AI senza assistenza esterna per le attività quotidiane?",
        options: [
          ...
          { letter: "C", score: 3, text: "Sì, il team usa gli strumenti in autonomia per la maggior parte dei compiti. Chiediamo supporto solo per situazioni particolari." },
          ...
          { letter: "E", score: 5, text: "Autonomo e proattivo: propone nuovi casi d'uso, valuta in autonomia se uno strumento è affidabile, identifica rischi prima di usarlo." },
        ],
      },
      {
        id: "S5",
        text: "Quando scoprite un nuovo strumento AI, la vostra organizzazione è in grado di valutare se è utile e sicuro, autorizzarlo, e formare i colleghi?",
        options: [
          { letter: "A", score: 1, text: "No. Qualcuno lo prova per conto suo, il management non sa se è stato valutato o autorizzato." },
          { letter: "B", score: 2, text: "Cerchiamo una valutazione (da IT o un consulente), ma non c'è un processo strutturato. La formazione è informale." },
          ...
          { letter: "D", score: 4, text: "Processo formale e documentato. I referenti AI sanno valutare utilità e conformità. La formazione è strutturata. Aggiornamenti ogni 3-6 mesi." },
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          { letter: "B", score: 2, text: "Sappiamo che alcuni dati non dovrebbero andare su ChatGPT (password, dati bancari), ma non abbiamo una lista formale. La regola è \"usa il buonsenso\"." },
      ...
      {
        id: "D3",
        text: "Avete visibilità su quali strumenti AI i dipendenti usano al di fuori di quelli autorizzati dall'azienda?",
        options: [
          { letter: "A", score: 1, text: "No, nessuna visibilità. Sappiamo che qualcuno usa ChatGPT, ma non sappiamo quanti, quanto spesso, o con quali dati." },
          ...
          { letter: "C", score: 3, text: "Abbiamo una regola che chiede di segnalare l'uso di nuovi strumenti, ma il monitoraggio è manuale e non sempre rispettato." },
      ...
      },
      {
        ...
        options: [
          ...
          { letter: "B", score: 2, text: "Abbiamo una piattaforma, ma tutti usano le stesse credenziali o non c'è distinzione di ruoli. Non tracciamo chi fa cosa." },
          ...
          { letter: "D", score: 4, text: "Accessi differenziati per ruolo (chi può fare cosa). Log completo di tutte le attività. Gli accessi vengono aggiornati quando cambia il ruolo o la persona lascia l'azienda." },
    ...
    questions: [
      {
        ...
        options: [
          ...
          { letter: "D", score: 4, text: "Piattaforma centralizzata con gestione utenti e ruoli, più modelli AI disponibili, e almeno un collegamento con i sistemi aziendali (CRM, gestionale, ecc.)." },
      ...
      {
        id: "T2",
        text: "Come sono configurati gli agenti AI nella vostra azienda? (un agente AI è un assistente personalizzato per un compito specifico)",
        options: [
          ...
          { letter: "C", score: 3, text: "1-3 agenti configurati con prompt personalizzati per attività specifiche (es. FAQ, estrazione documenti, assistenza procedure)." },
      ...
      {
        id: "T3",
        text: "La vostra piattaforma AI è collegata ai vostri sistemi aziendali (gestionale, CRM, archivio documenti, email)?",
        options: [
          ...
          { letter: "C", score: 3, text: "Sì, 1 integrazione pilota attiva (es. l'AI legge documenti dal nostro archivio)." },
          { letter: "D", score: 4, text: "Sì, 2-3 integrazioni operative (es. AI accede al CRM, consulta il gestionale, legge le email)." },
          { letter: "E", score: 5, text: "Sì, 4 o più integrazioni stabili con sincronizzazione automatica e flussi dati strutturati." },
        ],
      },
      {
        id: "T4",
        ...
        options: [
          ...
          { letter: "E", score: 5, text: "Reportistica avanzata: ROI per agente, costo per attività, tendenze di adozione, limiti di spesa automatici e previsioni." },
        ],
      },
      {
        id: "T5",
        ...
        options: [
          ...
          { letter: "B", score: 2, text: "Abbiamo documenti organizzati, ma gli strumenti AI non vi hanno accesso. La consultazione è manuale." },
          { letter: "C", score: 3, text: "Sì, 1 base di conoscenza pilota connessa a 1-2 agenti; le procedure sono parzialmente strutturate." },
          { letter: "D", score: 4, text: "Base di conoscenza centralizzata connessa a 3 o più agenti, con procedure standardizzate e accesso controllato." },
